...
$TestsRunGroups = @{
    ...
    "2012"              = 'autodetect_$TestConfig.instance2'
    "2014"              = 'autodetect_$TestConfig.instance3'
    "2016"              = 'autodetect_$TestConfig.instance4'
    "2017"              = 'autodetect_$TestConfig.instance5'
    "2019"              = 'autodetect_$TestConfig.instance6'
